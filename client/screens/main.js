...
export default class Main extends React.Component {
    ...
    fetchPlaces = () => {
        ...
        this.state.coffeeShops.forEach((c) => {
            fetch(`https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=${this.state.location.coords.latitude},${this.state.location.coords.longitude}&radius=400&keyword=${c}&key=AIzaSyBAelVldVfktZdswGiNk1STrQY2s_AxUCg`, {
                methos: "GET",
                credentials: "include",
                headers: {
                    "Content-Type": "application/json"
